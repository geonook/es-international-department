...
export default function ParentsCornerHomePage() {
  ...
  // Default hero image
  const heroImageUrl = '/api/placeholder/1920/600'
      ...
      urgent: [
        {
          ...
          content: "Please check the latest school guidelines",
          priority: 'high',
          status: 'active',
          notificationType: 'announcement',
          creator: {
            id: '1',
            displayName: 'ESID Admin'
          },
      ...
      regular: [
        {
          ...
          content: "This week's activities and updates",
          priority: 'medium',
          status: 'active',
          notificationType: 'newsletter',
          creator: {
            id: '2',
            displayName: 'Parent Coordinator'
          },
      ...
      upcoming: [
        {
          ...
          content: "Schedule your meeting with your child's teacher",
          eventType: 'meeting',
          isPinned: true,
          status: 'active',
          eventDate: '2025-09-15T14:00:00Z',
          location: 'Main Hall',
          organizer: {
            id: '1',
      ...
      featured: [
        {
          ...
          content: "Join us for a day of family activities",
          eventType: 'activity',
          isPinned: true,
          status: 'active',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-100 overflow-hidden">
      ...
      <main>
        {/* Hero Section */}
        <section id="home" ref={heroRef} className="relative py-16 overflow-hidden">
          ...
          <motion.div className="container mx-auto px-4 text-center relative z-10" style={{ y: y1, opacity }}>
            ...
            >
              ...
              >
                ...
                <Button 
                  className="relative bg-white/95 hover:bg-white text-purple-700 font-bold px-10 py-4 rounded-full shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 backdrop-blur-sm border-2 border-white/50 text-lg"
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    const mailto = 'mailto:parents@kcislk.ntpc.edu.tw?subject=Parent Support Request&body=Dear ESID Team,%0D%0A%0D%0APlease share your question or support request...'
            ...
            >
              ...
              <motion.div variants={itemVariants}>
                <Card className="bg-white/95 backdrop-blur-lg shadow-2xl border-0 overflow-hidden group hover:shadow-3xl transition-all duration-500 h-full">
                  ...
                  <CardContent className="p-6">
                    <p className="text-gray-600 mb-2 text-center font-semibold">2025 Academic Year</p>
              ...
              <motion.div variants={itemVariants}>
                <Card className="bg-white/95 backdrop-blur-lg shadow-2xl border-0 overflow-hidden group hover:shadow-3xl transition-all duration-500 h-full">
                  ...
                  <CardContent className="p-6">
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Button className="w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300">
                        <Users className="w-4 h-4 mr-2" />
                        View Events ({events.total})
                      </Button>
                    </motion.div>
                  </CardContent>
                </Card>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <p>&copy; 2025 Parents' Corner, KCIS ESID. All rights reserved.</p>
