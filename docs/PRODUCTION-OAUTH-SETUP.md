...
- **Production Domain**: `https://landing-app-v2.zeabur.app`
...
export NEXTAUTH_URL="https://landing-app-v2.zeabur.app"
...
2. Ensure exact match: https://landing-app-v2.zeabur.app/api/auth/callback/google
...
```bash
# Application health
curl https://landing-app-v2.zeabur.app/api/health
...
*Version: 1.0.0*  
*Deployment Target: https://landing-app-v2.zeabur.app*